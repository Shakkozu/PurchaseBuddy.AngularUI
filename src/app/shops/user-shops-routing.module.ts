...
const routes: Routes = [
  ...
  { path: 'user-shops/new', component: UserShopDetailsComponent, canActivate: [AuthGuard] },
  { path: 'user-shops/:id', component: UserShopDetailsComponent, canActivate: [AuthGuard] },
]
@NgModule({
